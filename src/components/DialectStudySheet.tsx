  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 md:p-6 transition-colors duration-300">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl md:text-2xl font-bold text-red-800 dark:text-red-400">Dialectes Catalans</h2>
      </div>
      ...
      <div className="mb-6 space-y-3">
        ...
        <div>
          ...
          {filterExpanded && (
            <div className="mt-2 p-4 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm">
              <h4 className="text-md font-semibold text-gray-800 dark:text-gray-100 mb-3">Ordenar per:</h4>
              ...
              {sortBy === 'random' && (
                <button
                  ...
                  className="flex items-center gap-2 py-1.5 px-3 text-sm rounded-md bg-yellow-100 dark:bg-yellow-900/40 text-yellow-700 dark:text-yellow-400 hover:bg-yellow-200 dark:hover:bg-yellow-900/60 transition-colors"
                >
                  <RefreshCw size={14} />
              ...
              <div className="flex flex-wrap gap-2 mt-4 text-xs text-gray-500 dark:text-gray-400">
                <div className="px-2 py-1 bg-gray-100 dark:bg-gray-600 rounded-full">
                  Total: {totalItems} dialectes
                </div>
                <div className="px-2 py-1 bg-red-50 dark:bg-red-900/40 text-red-600 dark:text-red-400 rounded-full">
                  Bloc Oriental: {orientalCount}
                </div>
                <div className="px-2 py-1 bg-blue-50 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 rounded-full">
            ...
            items.length > 0 && (
              <div key={groupId} id={`group-${groupId}`} className="scroll-mt-4">
                ...
                {isGroupedView && groupId !== 'all' && (
                  <h3 className="text-lg font-bold text-red-700 dark:text-red-400 border-b border-red-200 dark:border-red-800 pb-1 mb-3">
                    ...
                    >
                      ...
                      <div className={`expandable-content ${expandedItems[item.id] ? 'expanded' : ''}`}>
                        <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-600">
                          <div className="mb-3">
                            <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Caracteristiques:</h4>
                          ...
                          {item.examples && item.examples.length > 0 && (
                            <div>
                              <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Exemples:</h4>
                              <div className="space-y-2">
                                {item.examples.map((example, idx) => (
                                  <div key={idx} className="bg-gray-50 dark:bg-gray-700 p-2 rounded-md">
                                    ...
                                    <div className="text-xs text-gray-500 dark:text-gray-400">Estandard: {example.standardText}</div>
                                    {example.isPronunciation && (
