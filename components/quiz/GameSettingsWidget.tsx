...
export function GameSettingsWidget({
  ...
  const modes: Array<{
  ...
  }> = [
    {
      id: "barbarismes",
      title: "Barbarismes",
      description: "Practica amb paraules incorrectes en catala",
      icon: <Book size={22} />,
    },
    {
      id: "tots",
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mb-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-bold text-red-800 mb-4 text-left md:text-center">
          Configuracio del joc
        </h2>

        {/* Mode selection section */}
        <div className="mb-6">
          <h3 className="text-lg font-medium text-gray-700 mb-3 text-left md:text-center">
            Tipus de test
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {modes.map((mode) => (
              ...
              >
                <div
                  className={`p-2 rounded-full mb-1 mr-3 md:mr-0 md:mb-2 ${
