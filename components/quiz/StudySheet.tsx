                ...
                {groupedData[letter].map((item, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <span
                          className={`toggle-icon inline-block ${expandedItems[item.barbarism] ? "rotated" : ""}`}
                        >
                          {expandedItems[item.barbarism] ? (
                            <ChevronUp size={16} />
                          ) : (
                            <ChevronDown size={16} />
                          )}
                    ...
                    <div
                      className={`expandable-content ${expandedItems[item.barbarism] ? "expanded" : ""}`}
                    >
